...
<script type="text/javascript">
    ...
    function ajoutercode(){
        ...
        $('#code').val('');
        $('#date_limite').show();
        $('#remise').prop('placeholder','Entrez une remise');
        $('#remise_label').val('Remise que le code applique sur la commande (en %)');
        $('#date_label').show();
    }
    ...
    function ajouter_categorie()
    {
        ...
        $('#remise').prop('placeholder','Entrez une catégorie (Pizza, dessert, boisson, pâtes...)');
        $('#date_limite').hide();
        $('#remise_label').val('Catégorie');
        $('#date_label').hide();
    }

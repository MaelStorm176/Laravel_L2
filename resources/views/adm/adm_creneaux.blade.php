...
@section('contenu')
    <?php use App\User; ?>
    <button type="button" class="btn btn-outline-primary" data-toggle="modal" data-target="#ajouter_creneaux">
        Ajouter un créneau
    </button>
    <button type="button" class="btn btn-outline-primary" data-toggle="modal" data-target="#reini_creneaux">
        Réinitialiser les créneaux
    </button>
    <button type="button" class="btn btn-outline-primary" data-toggle="modal" data-target="#supprimer_jour">
        Supprimer un jour
    </button>
    ...
    <div class="container">
        <section class="row">
            <div class="col-lg-12">
                <div class="card border-info mb-3">
                    <div class="card-header bg-info text-white">Récapitulatif des créneaux<span class="fas fa-clock mt-1 float-right"></span></div>
                    <div class="card-body">
        ...
        <section class="row">
            <div class="col-lg-12">
                <div class="card border-info mb-3">
                    <div class="card-header bg-info text-white">Créneaux réservés<span class="fas fa-clock mt-1 float-right"></span></div>
                    <div class="card-body">
                        <table class="table table-hover table-bordered mb-3 text-center">
                            <thead class="bg-primary text-white">
                            <tr>
